...
# -*- coding: utf-8 -*-
"""
TWR x AI BOT - Professional Trading System
...
JSONBIN_API_KEY = "$2a$10$ar8HIDRzsj4es1aWX3E1n.NVCt2t2AvWvaHpWYk/H0m8zvoH0HzPS"  # API Key
...
TELEGRAM_BOT_TOKEN = "-1003769822504"  # Set your bot token here or via settings
TELEGRAM_CHAT_ID = "7794674282:AAE9E8P93dvZ4IHdqofY26JvFUmJe4Z27p8"
SIGNAL_USERNAME = "@TWR_ADMIN_01"  # নতুন ভেরিয়েবল
...
TELEGRAM_API_ID = 35701153  # Set your API ID here (get from my.telegram.org)
TELEGRAM_API_HASH = '18f87de47dd76e019a78a8300b56bafb'  # Set your API Hash here (get from my.telegram.org)
TELEGRAM_PHONE_NUMBER = '+8801721415894'  # Set your phone number here (with country code)
TELEGRAM_SOURCE_CHANNEL = "M1_Quotex_Vivo"  # সোর্স চ্যানেল ইউজারনেম (এখানে @ ছাড়া) - leave empty to disable
TELEGRAM_TARGET_CHANNELS = [+1003769822504]  # টার্গেট চ্যানেল আইডি (লিস্ট)
...
WATERMARK_ON = True
WATERMARK_TEXT = "TWR x AI BOT - TWR TRADER SS PRO"
SIGNAL_HEADER_TEXT = "TWR x AI BOT"
CHART_HEADER_TEXT = "TWR x AI BOT - TWR TRADER SS PRO SIGNAL"
...
async def trading_bot():
    ...
    email = "lamofa1455@vaztor.com"
    password = "lamofa1455@vaztor.com"
...
🚀 *TWR 𝐱 𝐀𝙸 𝐁𝐎𝐓 - 𝐏𝐫𝐨𝐟𝐞𝐬𝐬𝐢𝐨𝐧𝐚𝐥 𝐓𝐫𝐚𝐝𝐢𝐧𝐠 𝐒𝐲𝐬𝐭𝐞𝐦*"""
...
🚀 *TWR 𝐱 𝐀𝙸 𝐁𝐎𝐓 - 𝐓𝐫𝐚𝐝𝐢𝐧𝐠 𝐒𝐞𝐬𝐬𝐢𝐨𝐧 𝐄𝐧𝐝𝐞𝐝*"""
...
def main_menu():
    ...
    while True:
        try:
            clear_screen()
            print("\n" + "="*60)
            print(rainbow_text("🤖 TWR 𝐱 𝐀𝙸 𝐁𝐎𝐓 - 𝙿𝚛𝚘𝚏𝚎𝚜𝚜𝚒𝚘𝚗𝚊𝚕 𝚃𝚛𝚊𝚍𝚒𝚗𝚐 𝚂𝚢𝚜𝚝𝚎𝚖"))
            print("="*60)
            ...
            if choice == "1" and not bot_running: 
                ...
                stop_bot()
                save_trade_results()
                print(rainbow_text("👋 𝙶𝚘𝚘𝚍𝚋𝚢𝚎! 𝚃𝚛𝚊𝚍𝚎 𝚛𝚎𝚜𝚞𝚕𝚝𝚜 𝚜𝚊𝚟𝚎𝚍 𝚝𝚘 TWR.𝚓𝚜𝚘𝚗"))
                break
            else: 
                print(rainbow_text("❌ 𝙸𝚗𝚟𝚊𝚕𝚒𝚍 𝚘𝚙𝚝𝚒𝚘𝚗"))
